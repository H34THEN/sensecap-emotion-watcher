...
|---------|------|-----------------|-------|
| HOME | Boot → Home | Static HUD background edge-to-edge; **no blue/cyan conversion flares**; one strong option, index `1 / 6`; daily feed over background | `circe_home_bg.c`, `assets/circe_homepage_bg.c`, `circe_home_wheel.c` |
